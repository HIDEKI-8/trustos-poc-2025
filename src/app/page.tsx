...
const BtnGhost: React.FC<ButtonProps> = (props) => (
  <button
    {...props}
    style={{
...
export default function Home() {
  ...
  const [dao, setDao] = useState<DaoResult | null>(null);
  ...
  const approveDao = async () => {
    ...
    try {
      ...
      console.error(err);
      setMsg('Error submitting to DAO');
    } finally {
      setDaoLoading(false);
    }
  };
    ...
    >
      <div style={{ textAlign: 'center', maxWidth: 720, width: '100%', padding: 16 }}>
        ...
        >
          ...
          {msg && (
            <p style={{ opacity: 0.8, marginTop: 8, marginBottom: 0 }}>{msg}</p>
          )}
          {score !== null && (
            <div
              style={{
        ...
        >
          ...
          <Btn
            ...
            style={{ background: '#8BD3FF', color: '#00203F' }}
          >
